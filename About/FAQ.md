...
- **Proper time synchronization**: Heads underlying system clock MUST be in UTC/GMT timezone, and both your device and the smartphone must have accurate time. Smartphones typically sync time automatically through GSM/GPS/network, but Heads requires manual time adjustment through the Options menu. Time drift of more than 30 seconds can cause TOTP codes to not match
