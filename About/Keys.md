...
**Note**: TPMTOTP is generated by Heads itself using the TPM and is separate from any USB Security dongle requirements. This attestation method works with any smartphone authenticator app and doesn't require special hardware support from your USB Security dongle.
