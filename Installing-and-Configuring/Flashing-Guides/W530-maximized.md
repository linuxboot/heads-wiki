---
layout: default
title: Lenovo W530 Maximized
permalink: /W530-maximized-flashing/
nav_order: 11
...
<a id="platform-w530"></a>**Hardware:** w530 — see the [Hardware Compatibility List]({{ site.baseurl }}/Hardware-Compatibility/#platform-w530).
...
## Disassembly
The W530 shares the same board and SPI layout as the T530. See:
...
# Write the top ROM
sudo [flasher] --programmer [programmer] --chip <chip> --write ~/heads/build/x86/w530-maximized/w530-maximized-top.rom
...
sudo [flasher] --programmer [programmer] --chip <chip> --write ~/heads/build/x86/w530-maximized/w530-maximized-bottom.rom
```
