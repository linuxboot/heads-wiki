...
**USB3:** no integrated xHCI; the single X220 board covers both the i5 and i7 SKUs, and the i7 SKU's discrete Renesas/NEC controller means Heads keeps USB3/xHCI enabled — see [Install an OS → USB3]({{ site.baseurl }}/InstallingOS/#usb3).
