...
[For certian OSes](https://github.com/osresearch/heads/tree/master/initrd/etc/distro/keys),
 ...
 drive contains the installation media.  This is generally created using `dd` or
 `unetbootin` etc.  
 
### Alternative Options

 Heads also supports booting directly from verified ISOs on a plain
...
See Section ISO BOOT DETAILS for more infomation.
...
Heads will prompt you to set a default boot after installation during configuration.
