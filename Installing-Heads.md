...
Insert your Yubikey into the x230, then invoke GPG's the "Card Edit" function with
...
Wait a bit and the Qubes installer should get into graphical mode once dom0 kernel initializes graphics.
